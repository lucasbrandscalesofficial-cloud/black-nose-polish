const SiteNav = () => (
  <nav className="sticky top-0 z-50 bg-background px-[5%] py-[0.85rem] flex justify-between items-center" style={{ boxShadow: '0 1px 0 hsl(216 10% 90%)' }}>
    <div className="h-[38px] flex items-center">
      <img src="/images/logo.gif" alt="Black Nose Trading Company" className="h-full w-auto" />
    </div>
